  ...
  */
  ...
  const handleDeleteUser = async (id: string | null) => {
    ...
    if (!token) {
      ...
      return showError("Authenticator-Token für Löschvorgang erforderlich");
    }
    ...
    <View style={{ flex: 1 }}>
      ...
      >
        ...
        <ThemedView style={styles.otpWrapper}>
          ...
          >
            <ThemedText
              style={{ marginBottom: 12, fontSize: 12, opacity: 0.6 }}
            >
              Token zum Bestätigen des Löschens eingeben:
            </ThemedText>
            <OtpInput
              ref={otpRef}
              onComplete={(code) => {
